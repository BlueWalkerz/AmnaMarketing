        ...
        <section class="page-section bg-dark2" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Graphic Designing</h2>
                    <h3 class="section-subheading text-muted">Our Majestic Projects</h3>
                </div>
...
<div class="row">
        <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item ">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#cards-portfolio">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid" src="assets/img/graphdes/Us_Business_Card_Mockup_3.png" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Cards</div>
                                <div class="portfolio-caption-subheading text-muted">Amazing cards designed by our team</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <!-- Portfolio item 2-->
                        <div class="portfolio-item ">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#social-mediaportfolio">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid" src="assets/img/graphdes/instap1.png" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Social Media Posts</div>
                                <div class="portfolio-caption-subheading text-muted">Social Media Posts</div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- <section class="page-section bg-dark" id="services">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Social Media Marketing </h2>
                    <h3 class="section-subheadingz text-muted">We do Social Media Marketing.</h3>
                </div>
...
<?php
        ...
        <div class="portfolio-modal modal fade" id="cards-portfolio" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h2 class="text-uppercase">Bussiness-Cards</h2>
                                    ...
                                    <div class="rowxf">
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/Us_Business_Card_Mockup_2.png" alt="Card 1" onclick="piczoom1(this);">
                                      </div>
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/Us_Business_Card_Mockup_4.png" alt="Card 2" onclick="piczoom1(this);">
                                      </div>
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/Us_Business_Card_Mockup_5.png" alt="Card 2" onclick="piczoom1(this);">
                                      </div>
                                      <!-- <div class="columnxf">
        ...
        <div class="portfolio-modal modal fade" id="social-mediaportfolio" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content bg-dark">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h2 class="text-uppercase">Social Media Posts</h2>
                                    <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                    <div class="containerxf">
                                      <!-- Close the image -->
                                      <!-- <span onclick="this.parentElement.style.display='none'" class="closebtnt">&times;</span> -->
                                    ...
                                    <div class="rowxf">
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/facebook-mobile-mockup.png" alt="Nature" onclick="piczoom2(this);">
                                      </div>
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/facebook-mobile-mockup2.png" alt="Snow" onclick="piczoom2(this);">
                                      </div>
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/instagram-mobile-mockup.png" alt="Mountains" onclick="piczoom2(this);">
                                      </div>
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/instagram-mobile-mockup2.png" alt="Lights" onclick="piczoom2(this);">
                                      </div>
                                    </div>
                                    <!-- <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p> -->
                                    <!-- <ul class="list-inline">
