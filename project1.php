...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="assets/img/LogoAmna.svg" alt=".asdada." /></a>
        ...
        <header class="masthead">
            ...
            <span class="typed" id="typed"></span>
                ...
                <div class="masthead-heading text-uppercase"><span style="color:#f1c40f">Amna</span><br> Marketing Agency</div>
        ...
        <section class="page-section bg-dark" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheadingz text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
                </div>
                <section id="">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <button class=" btn-open btn-xl text-uppercase" data-bs-dismiss="modal" type="button">
