        ...
        <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item ">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#facebook-portfolio">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/facebook.png" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Facebook</div>
                                <div class="portfolio-caption-subheading text-muted">Social Media Marketing</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item ">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#instagram-portfolio">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/insta.png" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Instagram</div>
                                <div class="portfolio-caption-subheading text-muted">Instagram Account</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <div class="rowxf">
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/fb-likes.png" alt="Nature" onclick="piczoom1(this);">
                                      </div>
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/fb-page-reach.png" alt="Snow" onclick="piczoom1(this);">
                                      </div>
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/facebook-mobile-mockup2.png" alt="Mountains" onclick="piczoom1(this);">
                                      </div>
                                      <div class="columnxf">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <div class="rowxf">
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/insta-reach.png" alt="Nature" onclick="piczoom2(this);">
                                      </div>
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/insta-likes.png" alt="Snow" onclick="piczoom2(this);">
                                      </div>
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/insta-content-reach.png" alt="Mountains" onclick="piczoom2(this);">
                                      </div>
                                      <div class="columnxf">
                                        <img src="assets/img/graphdes/calender.png" alt="Lights" onclick="piczoom2(this);">
                                      </div>
                                    </div>
